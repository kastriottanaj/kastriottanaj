...
# Cloudinary — used in production for persistent media storage
# (Render free tier has an ephemeral filesystem, so uploads would otherwise vanish)
CLOUDINARY_STORAGE = {
...
# Logging — send tracebacks to stderr so Render captures them
LOGGING = {
    'version': 1,
